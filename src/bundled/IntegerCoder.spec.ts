...
describe('IntegerCoder', () => {
  ...
  it('asserts type on assert()', async () => {
    ...
    await expect(coder.assert(42.5)).to.be.rejectedWith(AssertionError)
  ...
  it('decodes type on decode()', async () => {
    ...
    await expect(coder.decode(42.5)).to.be.rejectedWith(DecodingError)
  ...
  it('coerces type on decode()', async () => {
    ...
    await expect(coder.decode(42.5, { coerceOnDecode: true })).to.be.rejectedWith(DecodingError)
    await expect(coder.decode('42.5' as any, { coerceOnDecode: true })).to.be.rejectedWith(DecodingError)
  ...
  it('encodes type on encode()', async () => {
    ...
    await expect(coder.encode(42.5)).to.be.rejectedWith(EncodingError)
